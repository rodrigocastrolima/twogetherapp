...
class CpeProposalLink {
  ...
  Map<String, dynamic> toJson() {
    return {'id': id, 'cpeName': cpeName, 'cpeRecordId': cpeRecordId};
  }

  CpeProposalLink copyWith({String? id, String? cpeName, String? cpeRecordId}) {
  ...
  String toString() {
    ...
    return 'CpeProposalLink(id: $id, cpeName: $cpeName, cpeRecordId: $cpeRecordId)';
  }
}
